...
foreach channel (ee emu mumu)
   ...
   foreach syst (JESDOWN JESUP JERDOWN JERUP MATCHUP MATCHDOWN MASSUP MASSDOWN PU_UP PU_DOWN SCALEUP SCALEDOWN MCATNLO POWHEG SPINCORR BTAG_UP BTAG_DOWN BTAG_LJET_UP BTAG_LJET_DOWN BTAG_PT_UP BTAG_PT_DOWN BTAG_ETA_UP BTAG_ETA_DOWN BTAG_LJET_PT_UP BTAG_LJET_PT_DOWN BTAG_LJET_ETA_UP BTAG_LJET_ETA_DOWN TRIG_UP TRIG_DOWN)
