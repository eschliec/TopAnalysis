...
foreach channel (ee emu mumu)
   ...
   foreach syst (JESDOWN JESUP JERDOWN JERUP MATCHUP MATCHDOWN MASSUP MASSDOWN PU_UP PU_DOWN SCALEUP SCALEDOWN MCATNLO POWHEG SPINCORR BTAG_UP BTAG_DOWN BTAG_PT_UP BTAG_PT_DOWN BTAG_ETA_UP BTAG_ETA_DOWN TRIG_UP TRIG_DOWN)
