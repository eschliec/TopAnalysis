...
foreach channel (ee emu mumu)
   ...
   foreach syst (JES_DOWN JES_UP JER_DOWN JER_UP MATCH_UP MATCH_DOWN MASS_UP MASS_DOWN PU__UP PU__DOWN TRIG__UP TRIG__DOWN SCALE_UP SCALE_DOWN MCATNLO POWHEG SPINCORR \
