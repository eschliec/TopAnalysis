...
NTupleWriter::NTupleWriter ( const edm::ParameterSet& iConfig ) :
    LVstr("ROOT::Math::LorentzVector<ROOT::Math::PtEtaPhiM4D<double> >"),
    VLVstr("std::vector<ROOT::Math::LorentzVector<ROOT::Math::PtEtaPhiM4D<double> > >"),
